...
Page({
  ...
  loadOrdersList: function (){
    orderList({
      ...
      page: this.data.active === 0 ? this.data.allListPage : this.data.active === 1 ? this.data.awaitUsePage : this.data.active === 2 ? this.data.awaitSendPage : this.data.active === 3 ? this.data.awaitReceivePage : this.data.active === 4 ? this.data.canclePage : -1,
      pageSize: 20
    })
    .then(res => {
      console.log(res)
